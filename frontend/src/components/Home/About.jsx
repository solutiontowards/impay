...
const About = () => {
      ...
      <div className="w-full mx-auto px-6 md:px-12 lg:px-20">
        <div className="text-center mb-16">
          <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-gray-900 mb-6">
            About <span className="text-blue-400">Impay</span>
          </h2>
          ...
          <div className="lg:w-1/2">
            <div className="space-y-6">
              ...
              <p className="text-gray-600 leading-relaxed">
                Impay is a leading fintech software provider dedicated to empowering businesses with innovative financial solutions. Our mission is to simplify complex financial processes through cutting-edge technology.
              </p>

              <p className="text-gray-600 leading-relaxed">
                Founded in 2023, we have grown to serve over 10,000 businesses worldwide, offering secure, scalable, and user-friendly platforms that transform financial operations.
              </p>
              ...
              <div className="grid grid-cols-2 gap-4 mt-8">
                <div className="bg-blue-50 p-4 rounded-lg">
                  ...
                  <p className="text-gray-600">Area Pincode We Cover</p>
                </div>
                <div className="bg-blue-50 p-4 rounded-lg">
                  <h4 className="font-bold text-blue-400 text-xl mb-2">
  ...
  className="mt-8 px-8 py-3 bg-blue-400 text-white font-medium rounded-lg hover:bg-blue-700 transition duration-300 shadow-md hover:shadow-lg inline-block"
>
