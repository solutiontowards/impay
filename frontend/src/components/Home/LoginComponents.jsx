...
export default function LoginComponents() {
    ...
    return (
        <div className="flex items-center justify-center ">
            <div className="flex md:flex-row flex-col-reverse w-full  rounded-2xl  bg-white overflow-hidden">
                {/* Left Side: Form */}
                <div className="w-full p-10 flex flex-col justify-center">
                    <h2 className="text-4xl font-extrabold text-gray-900 mb-8 text-center">Retailer Login</h2>
                    ...
                    <div className="space-y-6">
                        ...
                        {step === 'credentials' && (
                            <button
                                className="px-10 py-3 bg-[#2C3F98] text-white font-semibold rounded-lg hover:bg-blue-700 transition duration-200 disabled:opacity-50 whitespace-nowrap"
                                onClick={sendOtp}
                                disabled={loading}
                            >
                        ...
                        <div className="text-sm text-right">
                            <Link to="/forgot-password" className="font-medium text-[#2C3F98] hover:text-blue-500">
                                Forgot password?
                            </Link>
                        </div>
                        <div className="text-sm text-center">
                            <span className="text-gray-600">Don't have an account? </span>
                            <Link to="/register" className="text-[#2C3F98] hover:underline font-medium">
                                Register
                            </Link>
                        </div>
                    </div>
