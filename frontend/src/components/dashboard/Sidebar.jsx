...
const Sidebar = ({ isOpen, toggleSidebar }) => {
  ...
  const retailerLinks = [
    ...
    },
    {
      ...
      icon: ConciergeBell,
      submenu: [
        { to: "/retailer/pan-card", text: "Pan Card", icon: Tv },
        { to: "/retailer/driving-licence", text: "Driving Licence", icon: FileText },
        { to: "/retailer/insurance", text: "Insurance", icon: Landmark },
        { to: "/retailer/Income Tax File", text: "Income Tax File ", icon: WalletCards },
        { to: "/retailer/Gst", text: "Gst", icon: FileText },
      ],
    },
    {
      id: "my-business",
  ...
  const adminLinks = [
    ...
    {id:"Offline-Recharge-Request", to:"/st-admin/offline-recharge-request",text:"Offline Wallet Credit", icon:Wallet},
  ...
  return (
    <>
      ...
      <aside
        className={`fixed md:relative top-0 left-0 z-[9999] h-screen bg-[#252525] text-white shadow-xl 
