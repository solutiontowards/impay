            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
              ...
              {loading ? (
                ...
                <div className="bg-white rounded-2xl shadow-md p-6 flex flex-col items-center justify-center w-full">
                  <h3 className="text-lg font-semibold text-gray-800 mb-1">Total Application</h3>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-5">
          ...
          <div className="bg-white rounded-lg shadow-lg p-6 border-l-4 border-green-500">
            <div className="flex items-center gap-4">
              ...
              <div>
                <p className="text-gray-600 text-sm">Completed Application</p>
          ...
          <div className="bg-white rounded-lg shadow-lg p-6 border-l-4 border-orange-500">
            <div className="flex items-center gap-4">
              ...
              <div>
                <p className="text-gray-600 text-sm">Pending Application</p>
          ...
          <div className="bg-white rounded-lg shadow-lg p-6 border-l-4 border-red-500">
            <div className="flex items-center gap-4">
              ...
              <div>
                <p className="text-gray-600 text-sm">Cancelled Application</p>
