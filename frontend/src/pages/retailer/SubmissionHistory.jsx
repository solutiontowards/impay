  ...
  return (
    <div className="p-4 sm:p-6 bg-gray-50 min-h-screen">
      ...
      <div className="bg-white rounded-xl shadow-lg overflow-hidden">
        <div className="p-4 flex justify-between items-center flex-wrap gap-3 border-b  border-gray-200 sticky top-0 bg-[#2A2185] z-10">
        ...
        <div className="overflow-auto" style={{ maxHeight: '100vh' }}>
          <table className="w-full text-sm text-left">
            <thead className="bg-[#2A2185] text-white sticky top-0 z-50">
              <tr>
                {[
                  "Serial No",
                  "Action",
                  ...
                  <tr key={rowIndex} className="animate-pulse border-b border-gray-100">
                    {Array.from({ length: 17 }).map((_, colIndex) => (
                      <td key={colIndex} className="p-4">
                        <div className="h-4 bg-gray-200 rounded w-full opacity-60"></div>
                      </td>
                    ))}
                  </tr>
                ))
                  ...
                  <tr key={sub._id} className="hover:bg-gray-50/50 transition-colors">
                    ...
                    <td className="p-4 text-center">
                      <Link to={`/retailer/view-submission/${sub._id}`}
                        className="text-blue-600 hover:text-blue-800 p-2 rounded-full bg-blue-100 inline-block transition-colors" title="View Details">
                        <Eye size={28} />
                      </Link>
                    </td>
                    ...
                    <td className="p-4 text-gray-600 whitespace-nowrap">
                      <span className={`inline-block px-2 py-1 text-xs font-semibold rounded-full ${sub.finalDocument ? "bg-green-100 text-green-700" : "bg-red-100 text-red-700"
                        }`}>
