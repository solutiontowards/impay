...
export const getPendingWalletRecharges = () => api.get('/wallet/offline-requests');
// process-offline-request
export const processWalletRechargeRequest = (payload) => api.post('/wallet/process-offline-request', payload);
// Wishes
